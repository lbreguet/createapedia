...
/***/ function(module, exports, __webpack_require__) {
	...
	var articles = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onMenu = function onMenu(event) {
	  event.preventDefault();
	  api.index().then(ui.indexSuccess)
	  // .catch(ui.failure)
	  ;
	};

	var onGetUserArticles = function onGetUserArticles(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  if (data.article.id.length === 0) {
	    $('#searchbar-user').text('Please Enter a Valid ID Number.');
	  } else {
	    api.showUser(data.article.id).then(ui.showSuccess).catch(ui.showUserFailure);
	  }
	};

	var onGetArticles = function onGetArticles(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  if (data.article.id.length === 0) {
	    $('#searchbar').text('Please Enter a Valid ID Number.');
	  } else {
	    api.show(data.article.id).then(ui.showSuccess).catch(ui.showFailure);
	  }
	};

	var onCreateArticles = function onCreateArticles(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.create(data).then(ui.createSuccess).catch(ui.createFailure);
	};

	var onUpdateArticles = function onUpdateArticles(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  var id = event.target.dataset.id;
	  api.update(id, data).then(ui.updateSuccess).catch(ui.updateFailure);
	};

	var onDestroyArticles = function onDestroyArticles(event) {
	  event.preventDefault();
	  var id = event.target.dataset.id;
	  console.log('delete');
	  api.destroy(id).then(ui.destroySuccess)
	  // .catch(ui.failure)
	  ;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showArticlesTemplate = __webpack_require__(15);
	var showArticleTemplate = __webpack_require__(35);

	var indexSuccess = function indexSuccess(data) {
	  var showArticlesHtml = showArticlesTemplate({ articles: data.articles });
	...
	var showSuccess = function showSuccess(data) {
	  var showArticleHtml = showArticleTemplate({ article: data.article });
	...
	var showUserFailure = function showUserFailure() {
	  $('#searchbar-user').text('Please Enter a Valid ID Number.');
	};

	var showFailure = function showFailure() {
	  $('#searchbar').text('Please Enter a Valid ID Number.');
	};
	...
	var destroySuccess = function destroySuccess() {
	  $('.content').empty();
	};
	...
	module.exports = {
	  ...
	  showUserFailure: showUserFailure,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <div data-id=\""
	    ...
	    + "</h3>\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},((stack1 = blockParams[0][0]) != null ? stack1.description : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "      <p> Search #"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "</p>\n  </div>\n\n";
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.articles : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div data-id=\""
	    ...
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.article : depth0)) != null ? stack1.body : stack1), depth0))
	    + "</p>\n\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.article : depth0)) != null ? stack1.editable : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
	    + "</div>\n";
	},"useData":true});
